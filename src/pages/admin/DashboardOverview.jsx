                        ...
                        {lessons.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {lessons.slice(0, 5).map(lesson => (
                                    <div key={lesson.id} className="p-4 rounded-xl bg-cyber-surface-alt flex justify-between items-center group hover:bg-cyber-primary/5 transition-colors border border-transparent hover:border-cyber-primary/20">
                                        <div>
                                        ...
                                        <div className="px-3 py-1 rounded-full bg-cyber-bg text-xs font-bold text-cyber-primary">
                                            {questions.filter(q => q.lessonId === lesson.id).length} Qs
                                        </div>
                                    </div>
                                ))}
                            </div>
                ...
                <div>
                    <Card title="Quick Actions">
                        <div className="space-y-3">
                            <button className="w-full p-4 rounded-xl border border-cyber-border bg-cyber-bg text-cyber-text text-left flex items-center gap-3 hover:bg-cyber-surface-alt transition-colors group">
